...
async function main() {
    ...
    if (['-P', '--picture'].includes(opt)) {
        ...
        try {
            ...
            prettyPrinter(`The ${user.username}'s avatar has been downloaded at ${output}!`, 'blue', 'italic');
